...
/*DUM*/	{ PORTA	, 15	, PIO_INPUT				, PIN_ATTR_DIGITAL	, No_ADC_Channel	, NOT_ON_PWM	, NOT_ON_TIMER	, EXTERNAL_INT_NONE	},	// 8	| VDDANA		
				...
				{ PORTA	, 10	, PIO_TIMER_ALT				, PIN_ATTRIBUTE_PWM	, No_ADC_Channel	, PWM0_CH2		, TCC0_CH2		, EXTERNAL_INT_NONE	}, 	// 19	| TCC1_0, 			PWM5						// TCC0 2
				{ PORTA	, 11	, PIO_TIMER_ALT				, PIN_ATTRIBUTE_PWM	, No_ADC_Channel	, PWM0_CH3		, TCC0_CH3		, EXTERNAL_INT_NONE	}, 	// 20	| TCC1_1, 			PWM6						// TCC0 3
...
/*DUM*/	{ PORTA	, 15	, PIO_INPUT				, PIN_ATTR_DIGITAL	, No_ADC_Channel	, NOT_ON_PWM	, NOT_ON_TIMER	, EXTERNAL_INT_NONE	},	// 22	| GND		
				...
				{ PORTB	, 10	, PIO_OUTPUT		, PIN_ATTR_DIGITAL	, No_ADC_Channel	, NOT_ON_PWM		, NOT_ON_TIMER		, EXTERNAL_INT_NONE	}, 	// 23	| Servo1 (Motor1)		// TC5 0
				{ PORTB	, 11	, PIO_OUTPUT		, PIN_ATTR_DIGITAL	, No_ADC_Channel	, NOT_ON_PWM		, NOT_ON_TIMER		, EXTERNAL_INT_NONE	}, 	// 24	| Servo2 (Motor2)		// TC5 1
				{ PORTB	, 12	, PIO_OUTPUT		, PIN_ATTR_DIGITAL	, No_ADC_Channel	, NOT_ON_PWM		, NOT_ON_TIMER		, EXTERNAL_INT_NONE	}, 	// 25	| Servo3 (Motor3)		// TC4 0
				{ PORTB	, 13	, PIO_OUTPUT		, PIN_ATTR_DIGITAL	, No_ADC_Channel	, NOT_ON_PWM		, NOT_ON_TIMER		, EXTERNAL_INT_NONE	}, 	// 26	| Servo4 (Motor4)		// TC4 1
...
/*DUM*/	{ PORTA	, 15	, PIO_INPUT				, PIN_ATTR_DIGITAL	, No_ADC_Channel	, NOT_ON_PWM	, NOT_ON_TIMER	, EXTERNAL_INT_NONE	},	// 34	| VDDIO		
				...
				{ PORTA	, 16	, PIO_TIMER				, PIN_ATTRIBUTE_PWM	, No_ADC_Channel	, PWM2_CH0		, TCC2_CH0		, EXTERNAL_INT_NONE	}, 	// 35	| TCC2_0, 			PWM1 (IntLights)		// TCC0 6
				{ PORTA	, 17	, PIO_TIMER				, PIN_ATTRIBUTE_PWM	, No_ADC_Channel	, PWM2_CH1		, TCC2_CH1		, EXTERNAL_INT_NONE	}, 	// 36	| TCC2_1, 			PWM2 (Lasers)				// TCC0 7
				
				{ PORTA	, 18	, PIO_OUTPUT		, PIN_ATTR_DIGITAL	, No_ADC_Channel	, NOT_ON_PWM		, NOT_ON_TIMER		, EXTERNAL_INT_NONE	}, 	// 37	| Servo5 (Motor5)			// TC3 0
				{ PORTA	, 19	, PIO_OUTPUT		, PIN_ATTR_DIGITAL	, No_ADC_Channel	, NOT_ON_PWM		, NOT_ON_TIMER		, EXTERNAL_INT_NONE	}, 	// 38	| Servo6 (Motor6)			// TC3 1
				...
				{ PORTA	, 24	, PIO_TIMER_ALT		, PIN_ATTRIBUTE_PWM	, No_ADC_Channel	, PWM1_CH2		, TCC1_CH2		, EXTERNAL_INT_NONE	}, 	// 45	| TCC1_2,	 		PWM3 (ExtLights)			// TC5 0
				{ PORTA	, 25	, PIO_TIMER_ALT		, PIN_ATTRIBUTE_PWM	, No_ADC_Channel	, PWM1_CH3		, TCC1_CH3		, EXTERNAL_INT_NONE	}, 	// 46	| TCC1_3, 		PWM4									// TC5 1
...
/*DUM*/	{ PORTA	, 15	, PIO_INPUT				, PIN_ATTR_DIGITAL	, No_ADC_Channel	, NOT_ON_PWM	, NOT_ON_TIMER	, EXTERNAL_INT_NONE	},	// 58	| DEBUG SWDIO			
				...
				{ PORTB	, 30	, PIO_OUTPUT				, PIN_ATTR_DIGITAL	, No_ADC_Channel	, NOT_ON_PWM		, NOT_ON_TIMER			, EXTERNAL_INT_NONE	}, 	// 59	| Servo7 (CamTilt)			// TCC0 0
				{ PORTB	, 31	, PIO_OUTPUT				, PIN_ATTR_DIGITAL	, No_ADC_Channel	, NOT_ON_PWM		, NOT_ON_TIMER			, EXTERNAL_INT_NONE	}, 	// 60	| Servo8 (ExtServo)			// TCC0 1
